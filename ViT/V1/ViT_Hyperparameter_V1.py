...
TRAIN_JSON = "/cfs/earth/scratch/benkehel/ViLT/Data/trainV1_ViLT.json"
VAL_JSON = "/cfs/earth/scratch/benkehel/ViLT/Data/valV1_ViLT.json"
LOG_DIR = "/cfs/earth/scratch/benkehel/ViT/V1/optuna_logsV1"
...
def objective(trial):
    ...
    model = ViTMultiLabel(base_model, len(all_labels)).to(device)
    ...
    model_path = os.path.join(LOG_DIR, f"trial_{trial.number}_modelViTV1.pth")
    torch.save(model.state_dict(), model_path)
    csv_path = os.path.join(LOG_DIR, f"trial_{trial.number}_predictionsViTV1.csv")
    ...
    log_csv = os.path.join(LOG_DIR, "optuna_trial_logViTV1.csv")
