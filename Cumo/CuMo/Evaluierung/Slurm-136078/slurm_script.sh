...
python /cfs/earth/scratch/benkehel/CuMo/cumo/eval/model_vqa_loader.py \
  ...
  --image-folder /cfs/earth/scratch/benkehel/CuMo/data/trash_Papa \
  --question-file /cfs/earth/scratch/benkehel/CuMo/data/jsons/questions_FotosPapa.jsonl \
  --answers-file /cfs/earth/scratch/benkehel/CuMo/data/jsons/outputPapa.jsonl \
  --conv-mode llava_v1 \
  --temperature 0.0 \
  --num_beams 1 \
  --max_new_tokens 128
