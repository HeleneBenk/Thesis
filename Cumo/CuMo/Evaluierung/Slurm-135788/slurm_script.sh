...
python /cfs/earth/scratch/benkehel/CuMo/cumo/eval/model_vqa_loader.py \
  --model-path /cfs/earth/scratch/benkehel/CuMo/checkpoints/cumo-mistral-7b-sft/V1/checkpoint-900 \
  ...
  --question-file /cfs/earth/scratch/benkehel/CuMo/data/jsons/question.jsonl \
  --answers-file /cfs/earth/scratch/benkehel/CuMo/data/jsons/outputV1Checkpoint900.jsonl \
  --conv-mode llava_v1 \
  --temperature 0.0 \
  --num_beams 1 \
  --max_new_tokens 128
